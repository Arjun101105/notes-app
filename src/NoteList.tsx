...
export function NoteList({ availableTags, notes, onUpdateTag, onDeleteTag}:NoteListProps){
    ...
    <Row className="align-items-center mb-4">
        ...
        <Stack gap={2} direction="horizontal">
            ...
            <Button onClick={()=>setModalOpen(true)} variant="outline-secondary">Edit Tags</Button>
        </Stack>
        </Col>
    </Row>
    <Form>
    ...
    <EditTagsModal onDeleteTag={onDeleteTag} onUpdateTag={onUpdateTag} availableTags={availableTags} handleClose={()=>setModalOpen(false)} show={modalOpen} />
    </>
    )
}
